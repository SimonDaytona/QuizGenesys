...
public class ContenuFenetreChoixFormation extends JPanel implements ActionListener, FocusListener, KeyListener {
    ...
    JPanel pannelThemes = new JPanel(new GridLayout(4, 5));
    JPanel pannelFormations = new JPanel(new GridLayout(4, 5));
    JButton validation = new JButton("Valider");
    
    int modeBouton;

    public ContenuFenetreChoixFormation() {
    }
