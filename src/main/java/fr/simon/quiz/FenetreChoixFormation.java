...
public class FenetreChoixFormation  extends JFrame implements MenuListener, ActionListener {
    private static final long serialVersionUID = 7L;
    JPanel panneauMenu = new JPanel();
    JMenuBar barreMenu;
    JMenu menuFichier;
    JMenuItem quitter;
    ContenuFenetreChoixFormation cf = new ContenuFenetreChoixFormation();

    public FenetreChoixFormation() {
        int largeur = 600;
        int hauteur = 200;
        setContentPane(cf);
        setLocation(450, 350);
